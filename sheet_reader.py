...
# Очки начисляются за ВЫХОД в стадию: 1/16=0.5, 1/8=+1, 1/4=+2, 1/2=+3, чемпион=+4.
# Накопительно: 0.5=до 1/16, 1.5=до 1/8, 3.5=до 1/4, 6.5=до 1/2, 10.5=чемпион.
_PRED_LABEL = {10.5: "в чемпионы", 6.5: "до 1/2", 3.5: "до 1/4",
               1.5: "до 1/8", 0.5: "до 1/16"}
